...
<body>
    <h1>Toggle/Delete Operations Test</h1>
    <p>This page tests toggle and delete operations with detailed debugging.</p>
    ...
    <h2>Current Features (<?php echo count($features); ?>)</h2>
    ...
    <p>
        <a href="/admin/superadmin/features.php" style="color: #ff0000;">← Back to Features</a> |
        <a href="/admin/superadmin/newfeatures.php" style="color: #ff0000;">Add New Feature</a>
    </p>
