...
requireLogin();
$pageTitle = 'securitu ble scanner + logging gps osv..... mer kommer2 - Settings';
include '../header.php';
?>
<main class="main-content"><div class="container"><h3>Bluetooth Device Logg2</h3>
<table>
  <thead>
    <tr>
      <th>Dato</th>
...
<div class="back-link"><a href="/feature.php?slug=securitu-ble-scanner--logging-gps-osv-mer-kommer">← Back to Feature</a></div></div></main>
