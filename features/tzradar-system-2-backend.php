...
requireLogin();
$pageTitle = 'tøzradar system 3 - Settings';
include '../header.php';
?>
...
try {
  $pdo = new PDO("mysql:host=localhost;dbname=tozradar", "admin", "tozradar69");
  ...
  $res = $pdo->query("SELECT ip, country, city, os, browser, lang, visits, timestamp FROM ultra_log ORDER BY timestamp DESC LIMIT 100");
...
?><div class="back-link"><a href="/feature.php?slug=tzradar-system-2">← Back to Feature</a></div></div></main>
