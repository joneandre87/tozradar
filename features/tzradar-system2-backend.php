...
requireLogin();
$pageTitle = 'tøzradar system2 - Settings';
include '../header.php';
?>
<main class="main-content"><div class="container">if (!isset($_GET['json'])) {
...
exit;
?><div class="back-link"><a href="/feature.php?slug=tzradar-system2">← Back to Feature</a></div></div></main>
