...
requireLogin();
$pageTitle = 'securitu ble scanner + logging gps osv..... mer kommer2';
include '../header.php';
?>
<main class="main-content"><div class="container"><h2>🔍 TozRadar Bluetooth GPS Auto-Tracker</h2>
<p>Skanner Bluetooth-enheter med AI-type, lagrer GPS, teller enhetsfunn, viser på kart og støtter offline-logging.</p>
